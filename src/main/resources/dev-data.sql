...
('test', 'test@test.com', '$2a$10$79.l8wpc.yZ6CnXz6a18H.dM3Jb47V8HIfd44Xm57GvS1O8o2jMAC', 'HAS_ACCOUNT', NULL, NULL, NULL, (SELECT id FROM city WHERE name = 'Cape Town'), NULL, NULL, 'profiles/10/profile.jpg'),
...
('mike_wilson', 'mike@example.com', '$2a$10$79.l8wpc.yZ6CnXz6a18H.dM3Jb47V8HIfd44Xm57GvS1O8o2jMAC', 'HAS_ACCOUNT', 'Mike', 'Wilson', 'Home improvement expert and furniture restorer. Quality craftsmanship guaranteed.', (SELECT id FROM city WHERE name = 'Bloemfontein'), NULL, '+27-51-555-0103', 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
...
('alex_chen', 'alex@example.com', '$2a$10$79.l8wpc.yZ6CnXz6a18H.dM3Jb47V8HIfd44Xm57GvS1O8o2jMAC', 'HAS_ACCOUNT', 'Alex', 'Chen', 'Sports equipment dealer and outdoor enthusiast. Certified in sports equipment maintenance.', (SELECT id FROM city WHERE name = 'Durban'), NULL, '+27-31-555-0105', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('lisa_johnson', 'lisa@example.com', '$2a$10$79.l8wpc.yZ6CnXz6a18H.dM3Jb47V8HIfd44Xm57GvS1O8o2jMAC', 'HAS_ACCOUNT', 'Lisa', 'Johnson', 'Art collector and gallery owner. Specializing in contemporary and modern art.', (SELECT id FROM city WHERE name = 'Cape Town'), NULL, '+27-21-555-0106', 'https://images.unsplash.com/photo-1515138692129-197a2c608cfd?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('david_brown', 'david@example.com', '$2a$10$79.l8wpc.yZ6CnXz6a18H.dM3Jb47V8HIfd44Xm57GvS1O8o2jMAC', 'HAS_ACCOUNT', 'David', 'Brown', 'Musician and instrument dealer. Professional guitarist with 15 years experience.', (SELECT id FROM city WHERE name = 'Pretoria'), NULL, '+27-12-555-0107', 'https://images.unsplash.com/photo-1504257432389-52343af06ae3?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('maria_garcia', 'maria@example.com', '$2a$10$79.l8wpc.yZ6CnXz6a18H.dM3Jb47V8HIfd44Xm57GvS1O8o2jMAC', 'HAS_ACCOUNT', 'Maria', 'Garcia', 'Jewelry designer and gemologist. Certified appraiser with GIA credentials.', (SELECT id FROM city WHERE name = 'Kimberley'), NULL, '+27-53-555-0108', 'https://images.unsplash.com/photo-1508185140592-283327020902?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')
...
INSERT INTO trust_rating (user_id, verified_id, overall_score, profile_score, review_score, transaction_score, total_reviews, positive_reviews, total_transactions, successful_transactions)
SELECT 
    u.id,
    true as verified_id,
...
VALUES
('00000000-0000-0000-0000-000000000001', 'reviewer1', 'reviewer1@example.com', '$2a$10$dummyhash', 'HAS_ACCOUNT', 'Reviewer', 'One'),
('00000000-0000-0000-0000-000000000003', 'reviewer3', 'reviewer3@example.com', '$2a$10$dummyhash', 'HAS_ACCOUNT', 'Reviewer', 'Three'),
('00000000-0000-0000-0000-000000000004', 'reviewer4', 'reviewer4@example.com', '$2a$10$dummyhash', 'HAS_ACCOUNT', 'Reviewer', 'Four'),
('00000000-0000-0000-0000-000000000006', 'reviewer6', 'reviewer6@example.com', '$2a$10$dummyhash', 'HAS_ACCOUNT', 'Reviewer', 'Six'),
('00000000-0000-0000-0000-000000000011', 'reviewer11', 'reviewer11@example.com', '$2a$10$dummyhash', 'HAS_ACCOUNT', 'Reviewer', 'Eleven')
